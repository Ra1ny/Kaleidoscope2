...
(function() {
  var DragDrop, HashNavigation, Kaleidoscope, c, cyclePos, dragger, gui, hash, image, imagesPath, kaleidoscope, onChange, onMouseMoved, options, presetImages, sameImageCycles, startAnimation, toggleInteractive, tr, tx, ty, update, _i, _len, _ref,
  ...
  HashNavigation = (function() {
    function HashNavigation() {
      this.vals = document.location.hash.replace('#/', '').replace('#', '').split('/');
    }

    HashNavigation.prototype.getVal = function(index) {
